...
import { FRAGMENT_MAIN } from './FRAGMENT_MAIN.js';
import { BUFFER_FRAGMENT_A } from './BUFFER_FRAGMENT_A.js';
// import { BUFFER_FRAGMENT_B } from './BUFFER_FRAGMENT_B.js';
...
const bufferAPass = new ShaderPass(new THREE.ShaderMaterial({
    uniforms: {
        ...
        iChannel1: { value: new THREE.TextureLoader().load('./B.png') }
    },
    vertexShader: VERTEX,
